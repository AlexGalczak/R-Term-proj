...
test = ggplot(data=generated, aes(x=Year, y= Weight_tons)) + geom_col(aes(fill = Materials), position = 'dodge') + scale_fill_brewer(palette="Dark2") + ylab('Weight (tons)') + ggtitle('Trash production in the United States 1960-2018') +
...
ggplot(data=generated_tot, aes(x=Year, y= Weight_tons)) + geom_area( fill="#69b3a2", alpha=0.4) +
  geom_line(color="#69b3a2", size=2) +
  geom_point(size=3, color="#69b3a2")

ggplot(data=generated, aes(x=Year, y= Weight_tons)) + geom_area() 
...
ggplot(data=generated, aes(x=Year, y= Weight_tons)) + geom_col(aes(fill = Materials), position = 'dodge') + scale_fill_brewer(palette="Dark2") + ylab('Weight (tons)') + ggtitle('Trash production in the United States 1960-2018') +
theme_bw() + 
  theme(
...
world_map2018 <- ggplot() +
  ...
  scale_color_brewer(palette="Dark2") +
  theme_void() +
  theme(legend.position = "right", plot.background = element_rect(fill = "lightblue")) + 
  ggtitle("Volunteer Clean Up Events 2015-2018") +
  ylim(-50, NA)
